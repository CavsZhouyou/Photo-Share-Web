...
//get the view
var personalInfo = __webpack_require__(38);
...
SPA_RESOLVE_INIT = function SPA_RESOLVE_INIT(transition) {
    ...
    function getPersonalData() {
        ...
        //获取用户信息
        $.ajax({
            url: "/share/user/getUserByAccount",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
